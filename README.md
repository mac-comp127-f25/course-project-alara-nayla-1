...
- Display Issues: On smaller screens, the 900x900 game window may not display at its full size or may extend beyond your screen boundaries.
...
- Some potential improvements for inclusivity could be: audio cues for the game, more accessible controllers that do not fully depend on a keyboard, adjustabke difficulty, a more colorblind-friendly palette, and screen-reader compatibility, among others.
